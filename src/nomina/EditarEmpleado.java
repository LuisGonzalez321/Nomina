...
public class EditarEmpleado extends javax.swing.JFrame {
    ...
    public EditarEmpleado(File file, JButton boton, int empleado) {
        Funcion.setVentanaEditarE(this);
        this.file = file;
        this.nomina = (ArrayList<Empleado>) Funcion.cargarArchivo(file);
        this.boton = boton;
        this.empleado = empleado;
        Funcion.setHijos(nomina.get(empleado).getHijos());
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Nómina - Editar Empleado");
        setResizable(false);
        ...
        caja_estado.setSelectedItem(nomina.get(empleado).getEstado_civil());
        ...
        caja_nivel.setSelectedItem(nomina.get(empleado).getNivel_academico());
        ...
        caja_hijos.setSelectedIndex(nomina.get(empleado).getHijos().size());
        if (!caja_hijos.getSelectedItem().equals("0"))
        ...
        caja_nacimiento.setDate(nomina.get(empleado).getFecha_nacimiento());
        ...
        ciudad_nacimiento.setText(nomina.get(empleado).getLugar_nacimiento().getCiudad());
        ciudad_nacimiento.setMaxLength(50);
        ciudad_nacimiento.setPlaceHolder(" Ciudad");

        departamento_nacimiento.setText(nomina.get(empleado).getLugar_nacimiento().getDepartamento());
        departamento_nacimiento.setMaxLength(50);
        departamento_nacimiento.setPlaceHolder(" Departamento");

        pais_nacimiento.setText(nomina.get(empleado).getLugar_nacimiento().getPais());
        ...
        campo_direccion.setText(nomina.get(empleado).getDireccion());
        ...
        campo_cedula.setText(nomina.get(empleado).getCedula());
        ...
        campo_numero.setText(nomina.get(empleado).getNumero_contacto());
        campo_numero.setMaxLength(20);

        campo_nombre.setText(nomina.get(empleado).getNombre_apellido()
        );
        ...
        campo_deplab.setSelectedItem(nomina.get(empleado).getDepatamento_lab());
        ...
        caja_tipo.setSelectedItem(nomina.get(empleado).getTipo_contratacion());
        ...
        caja_jornada.setSelectedItem(nomina.get(empleado).getJornada_laboral());

        caja_ingreso.getDateEditor().setEnabled(false);
        caja_ingreso.setDate(nomina.get(empleado).getFecha_ingreso());
        ...
        campo_cargo.setText(nomina.get(empleado).getCargo());
        campo_cargo.setMaxLength(50);

        campo_profecion.setText(nomina.get(empleado).getProfecion());
        campo_profecion.setMaxLength(50);

        jLabel18.setFont(new java.awt.Font("Verdana", 1, 11)); // NOI18N
        jLabel18.setText("Salario bruto:");

        campo_salario.setText(String.valueOf(nomina.get(empleado).getSalario_mensual()));
        ...
        campo_inss.setText(nomina.get(empleado).getNo_inss());
        campo_inss.setMaxLength(9);

        ciudad_ubicaccion.setText(nomina.get(empleado).getUbicacion_fisica().getCiudad());
        ciudad_ubicaccion.setPlaceHolder(" Ciudad");

        departamento_ubicacion.setText(nomina.get(empleado).getUbicacion_fisica().getDepartamento());
        departamento_ubicacion.setPlaceHolder(" Departamento");

        pais_ubicacion.setText(nomina.get(empleado).getUbicacion_fisica().getPais());
        ...
        estudios_realizados.setText(nomina.get(empleado).getEstudios_realizados());
        if(caja_nivel.getSelectedIndex() > 1)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(campo_profecion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(65, 65, 65))
        );
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(22, 266, 984, 244);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        nomina.get(empleado).setLugar_nacimiento(nacimiento);
        nomina.get(empleado).setUbicacion_fisica(ubicacion);
        nomina.get(empleado).setFecha_nacimiento(caja_nacimiento.getDate());
        nomina.get(empleado).setFecha_ingreso(caja_ingreso.getDate());
        nomina.get(empleado).setTipo_contratacion(String.valueOf(caja_tipo.getSelectedItem()));
        nomina.get(empleado).setJornada_laboral(String.valueOf(caja_jornada.getSelectedItem()));
        nomina.get(empleado).setNivel_academico(String.valueOf(caja_nivel.getSelectedItem()));
        nomina.get(empleado).setDireccion(campo_direccion.getText());
        nomina.get(empleado).setNumero_contacto(campo_numero.getText());
        nomina.get(empleado).setNombre_apellido(campo_nombre.getText());
        nomina.get(empleado).setEstado_civil(String.valueOf(caja_estado.getSelectedItem()));
        nomina.get(empleado).setProfecion(campo_profecion.getText());
        nomina.get(empleado).setDepatamento_lab(String.valueOf(campo_deplab.getSelectedItem()));
        nomina.get(empleado).setCedula(campo_cedula.getText());
        nomina.get(empleado).setNo_inss(campo_inss.getText());
        nomina.get(empleado).setCargo(campo_cargo.getText());
        nomina.get(empleado).setSalario_mensual(Double.parseDouble(campo_salario.getText()));
        nomina.get(empleado).setHijos(hijos);
        nomina.get(empleado).setEstudios_realizados(estudios_realizados.getText());
