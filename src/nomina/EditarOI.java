...
public class EditarOI extends javax.swing.JFrame {
    ...
    public EditarOI(JTable tabla, int row, int colm, ArrayList<Empleado> nomina, Modelo modelo, MouseListener listener) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Otros Ingresos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 14))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/67509845-Contabilidad-background-abstract-motive-Banking-matem-tica--Foto-de-archivo.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(331, 181));
        jLabel1.setMinimumSize(new java.awt.Dimension(331, 181));
        jLabel1.setPreferredSize(new java.awt.Dimension(331, 181));
        jPanel1.add(jLabel1);
        jLabel1.setBounds(-450, -210, 1180, 620);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        nomina.get(row).setOtros_ingresos(Double.parseDouble(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(EditarOI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
