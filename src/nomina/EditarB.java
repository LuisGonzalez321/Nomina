...
public class EditarB extends javax.swing.JFrame {
    ...
    public EditarB(JTable tabla, int row, int colm, ArrayList<Empleado> nomina, Modelo modelo, MouseListener listener) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Bonos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 14))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Contabilidad.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        nomina.get(row).setBonos(Double.parseDouble(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(EditarB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /*java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarBEditarB().setVisible(true);
            }
